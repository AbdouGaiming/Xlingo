...
export const generatePronunciationExercises = async (language, level) => {
  try {
    ...
    try {
      ...
      console.error(
        "Failed to parse pronunciation exercises JSON:",
        parseError
      );
 ...
 */
export const practiceConversation = async (
  language,
  level,
  scenario,
  userMessage
  ...
  try {
    ...
    return {
      reply:
        "I'm sorry, I couldn't process your message right now. Let's try again later.",
      correction: null,
      suggestion: null,
      error: error.message,
    };
...
export const translateText = async (
  ...
  try {
    // Check if we have a cached response for this query
    const cacheKey = `translation_${sourceLanguage}_${targetLanguage}_${text.substring(
      0,
      50
    )}`;
    const cachedResponse = localStorage.getItem(cacheKey);
    ...
    const prompt = `
      ...
      ${
        includeExplanation
          ? `Also provide brief explanations about any interesting grammar, idioms, or cultural context in the translation.`
          : ""
      }
    ...
    try {
      ...
      if (includeExplanation) {
        const explanationsMatch = responseText.match(
          /Explanations:\s*(.*?)(?=\s*$)/s
        );
  ...
  try {
    ...
    try {
      ...
      return {
        ...
        corrections: [],
        generalFeedback:
          "Error parsing response. Please try again with different text.",
      };
    }
  } catch (error) {
  ...
  return [
    {
      ...
      example:
        "Use a language learning app during your daily commute or coffee break.",
      difficulty: "easy",
    },
    {
    ...
    },
    {
      ...
      description:
        "Don't wait until you feel 'ready' to speak. Practice speaking from the beginning.",
      example:
        "Record yourself speaking or find a language exchange partner online.",
      difficulty: "medium",
    },
    {
      title: "Use Spaced Repetition",
      description:
        "Review vocabulary at increasing intervals to optimize memorization.",
      example:
        "Use flashcard apps like Anki that implement spaced repetition algorithms.",
      difficulty: "easy",
    },
    {
...
function generateMockLesson(language, level, topic) {
  ...
  return {
    ...
    vocabulary: [
      {
        word: targetLanguage.hello,
        translation: "Hello",
        example: `${targetLanguage.hello}, ¿cómo estás?`,
      },
      {
        word: targetLanguage.goodbye,
        translation: "Goodbye",
        example: `${targetLanguage.goodbye}, hasta mañana.`,
      },
      {
        word: targetLanguage.please,
        translation: "Please",
        example: `${targetLanguage.please}, ayúdame.`,
      },
      {
        word: targetLanguage.thanks,
        translation: "Thank you",
        example: `${targetLanguage.thanks} por tu ayuda.`,
      },
    ],
    grammar: {
    ...
    conversationPractice: [
      ...
      {
        role: "speaker2",
        text: targetLanguage.hello + ", " + targetLanguage.thanks,
      },
    ],
  };
}
  ...
  const topics = {
    Food: [
      {
        word: "el pan",
        translation: "bread",
        pronunciation: "el pahn",
        example: "Me gusta el pan fresco.",
      },
      {
        word: "la manzana",
        translation: "apple",
        pronunciation: "lah mahn-ZAH-nah",
        example: "Como una manzana cada día.",
      },
      {
        word: "el queso",
        translation: "cheese",
        pronunciation: "el KEH-so",
    ...
    Travel: [
      ...
      },
      {
        word: "el tren",
        translation: "train",
        pronunciation: "el trehn",
        example: "Viajo en tren a menudo.",
      },
      {
        word: "el pasaporte",
        translation: "passport",
        pronunciation: "el pah-sah-POR-teh",
        example: "Necesito mi pasaporte para viajar.",
      },
      {
        word: "la playa",
        translation: "beach",
        pronunciation: "lah PLAH-yah",
    ...
    return [
      {
        sound: "The Spanish 'r'",
        explanation:
          "The Spanish 'r' is a tapped sound, made by quickly tapping the tongue against the roof of the mouth.",
      ...
      },
      {
        sound: "The Spanish 'j'",
        explanation:
          "The Spanish 'j' is pronounced like an English 'h' but more guttural.",
    ...
    return [
      {
        ...
        explanation:
          "French has nasal vowels where air passes through the nose and mouth.",
      ...
      },
      {
        ...
        explanation:
          "The French 'u' is pronounced with rounded lips and the tongue raised toward the front of the mouth.",
        examples: ["tu", "rue", "dur"],
...
// Create a named variable for the exported service
const GeminiService = {
  generateLesson,
  generateVocabulary,
